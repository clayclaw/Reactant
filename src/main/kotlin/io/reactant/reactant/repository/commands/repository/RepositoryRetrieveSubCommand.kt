...
import io.reactant.reactant.core.ReactantCore.Companion.tmpDirPath
import io.reactant.reactant.extensions.jarLocation
...
import io.reactant.reactant.utils.converter.StacktraceConverterUtils
...
class RepositoryRetrieveSubCommand(private val repositoryService: RepositoryService,
    ...
    private fun installPlugin(tmpFile: File): Single<File> = Single.fromCallable {
        ...
        tmpFile.delete()
        installLocation
    }.subscribeOn(io.reactant.reactant.core.ReactantCore.mainThreadScheduler)
