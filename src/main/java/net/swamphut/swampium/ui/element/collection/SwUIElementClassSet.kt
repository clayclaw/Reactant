...
class SwUIElementClassSet(private val attributes: UIElementAttributes) : MutableSet<String> {
    ...
    inner class StringMutableIterator(val iterator: MutableIterator<String> = classSet.iterator())
        ...
        override fun remove() = iterator.remove().also { this@SwUIElementClassSet.remove(lastValue) }
    }
